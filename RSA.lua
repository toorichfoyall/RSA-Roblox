...
local holdingDown = false -- Track if the button is held down
...
-- Silent aim functionality with headshots while holding down
UserInputService.InputBegan:Connect(function(input)
    if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.KeyCode == Enum.KeyCode.ButtonR2) and silentAimActive then
        ...
        while holdingDown do
            ...
            wait(0.1) -- Adjust the delay as needed for repeat rate
        end
    end
end)
